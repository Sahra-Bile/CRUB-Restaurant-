  ...
  return (
    <section className="menu-container">
      ...
      <article className="menu-container__article">
        ...
        <h5 className="menu-container__article__name">Vårrullar</h5>
        <span className="menu-container__article__is">
          Vårrullar gjorda på mungbönor, mango, morot, zucchini, tofu och
          sötpotatisnudlar serveras med en fräsch kålslå.
        </span>
        <span className="menu-container__article__price">{lunchprice}</span>
        <h5 className="menu-container__article__name">Mammas kottbullar</h5>
        <span className="menu-container__article__is">
          Klassiska vegobullar gjorda på sojafärs serveras med brunsås och
          norrlänskt potatismos.
        </span>
        <span className="menu-container__article__price">{lunchprice}</span>
      </article>
      <article className="menu-container__article">
        ...
        <span className="menu-container__article__is">
          Plankstek gjord på Seitan serveras klassiskt med potatismos, vegansk
        ...
        <span className="menu-container__article__is">
          En stroganoff byggd på vegetarisk sojakorv med en himmelsk tomatsås,
          dijonsenap och persilja. Serveras med råris och färsk vårsallad.
        </span>
        <span className="menu-container__article__price">{dinnerprice}</span>
      </article>
      <article className="menu-container__article">
